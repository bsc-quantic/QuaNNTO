...
The different addressed tasks are contained in `quannto/tasks` directory and they train multiple QONN models with their hyperparameters defined at the beggining of each task file. They are divided in the following scripts:
